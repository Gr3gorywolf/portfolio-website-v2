                                ...
                                <div>
                                    ...
                                    >
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground">
                                                {truncateString(lastCommit.commit?.message, 180)}
                                            </p>
                                        </div>
                                        <ExternalLink className="w-3 h-3 text-muted-foreground ml-auto" />
                                    </Link>
                            ...
                            <div className="space-y-3">
                                {project.actions?.map((action, index) => (
                                    <Button
                                        asChild
                                        variant="outline"
                                        className="w-full justify-start bg-transparent h-12 action-button"
                                    >
                                ...
                                {!hasSubprojects && (
                                    <Button
                                        asChild
                                        variant="outline"
                                        className="w-full justify-start h-12 bg-transparent action-button"
                                    >
